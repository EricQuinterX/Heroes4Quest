...
//    assertEquals(juanNuevo.equipo.get, losSinTrabajo3) ---> por algo no esta en el enunciado xD
  ...
  def liderDeUnEquipo_SinTrabajo(): Unit = {
    val juan4 = new Heroe(new Stats(40,40,40,40))
    val losSinTrabajo2= losSinTrabajo.obtieneMiembro(juan4)
    assertEquals(losSinTrabajo2.lider,Some(juan4))
  }
  ...
  def liderDeUnEquipo_ConTrabajo_Guerrero(): Unit = {
    ...
    assertEquals(losSinTrabajo2.lider,Some(juanGuerrero))
  }


  @Test
  def sinlider_PorEquipoVacio(): Unit = {
    assertEquals(equipoVacio.lider, None)
  }
  ...
  def sinliderDeUnEquipo(): Unit = {
    ...
    assertEquals(losSinTrabajo2.lider, None)
  }
  ...
  def obtenerItem_CumpleConciconUnHeroe(): Unit = {
    ...
    assertEquals(losSinTrabajo3.pozoDeOro, 100)
    assertEquals(losSinTrabajo3.lider.get.atributos.fuerza,62)
  }
  ...
  def obtenerItem_NoCumpleCondicion(): Unit = {
    ...
    assertEquals(losSinTrabajo2.lider.get.stats.hp, 25)
  }
  ...
  def obtenerItem_CumpleCondicion_Con_Mago(): Unit = {
    ...
    assertEquals(losSinTrabajo3.lider.get.atributos.hp,75)
  }
}
